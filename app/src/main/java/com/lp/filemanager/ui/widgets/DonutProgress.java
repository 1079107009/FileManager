...
public class DonutProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        finishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgress_donut_finished_stroke_width,
                DensityUtil.dp2px(getContext(), 3));
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgress_donut_unfinished_stroke_width,
                DensityUtil.dp2px(getContext(), 3));
        ...
        startingDegree = attributes.getInt(R.styleable.DonutProgress_donut_circle_starting_degree, 0);
